...
/// `parts` is the SOLE source of truth for a message's content (Batch A
...
// MARK: - Deterministic seeded identity
...
extension ChatMessage {
    ...
    // review note #1): a new `.tools` cluster only opens when a
