...
///  in a native slide-up `.sheet` with `[.medium, .large]` detents,
...
/// accent to `theme.midground` per the spec.
struct WelcomeView: View {
    ...
    /// Drives the slide-up manual-setup sheet. Replaces the prior
