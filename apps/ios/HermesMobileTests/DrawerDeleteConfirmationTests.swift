...
/// delete-confirmation staging state.
///

/// The destructive-delete confirmation introduces a two-step flow in
...
/// correctness logic, which is fully covered by `SessionDeleteFlowTests`.
///
