...
/// W3 — REST path-family migration tests.
///
...
final class PathStyleTests: XCTestCase {
    ...
    private func makeClient(style: APIPathStyle, script: [(Data, Int)]) -> RestClient {
        ...
        return RestClient(
            baseURL: URL(string: "https://gw.example:8080")!,
            token: "tok",
    ...
    func testCachedPathStyleReadsThePersistedSnapshot() async {
        ...
        let caps = ServerCapabilities()
        await caps.probe(serverURL: "https://gw.example:8080", rest: rest)
        ...
        XCTAssertEqual(
            ServerCapabilities.cachedPathStyle(serverURL: "https://gw.example:8080"),
            .plugin
        )
