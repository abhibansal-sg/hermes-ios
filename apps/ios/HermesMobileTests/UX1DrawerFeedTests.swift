...
final class UX1DrawerFeedTests: XCTestCase {
    ...
    // MARK: - optimistic activity bump + re-sort
    ...
    /// forward via the `turnsInProgress` flag (explicit flag replaced the
    ...
    func testNoteActivityReSortsAndSurvivesStaleRefresh() async {
        ...
        // the carry-forward now requires an explicit turn-in-flight flag.
