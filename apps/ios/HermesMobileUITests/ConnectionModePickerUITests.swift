...
/// Verifies the Increment 1 connection-mode picker (the design contract-MODES.md §Inc1).
///
...
final class ConnectionModePickerUITests: XCTestCase {
    ...
    // MARK: - Test 2: Select Remote URL → enter:8080 URL+token → connected + session row
