...
/// CONTRACT (the design contract-MODES.md §Inc3b):
...
/// :8080 gateway from `scripts/ios-build.sh test`).
///
...
final class LocalDesktopManualTokenUITests: XCTestCase {
    ...
    /// Injects `hermesapp://pair?url=http://127.0.0.1:8080&manual_token=true`
    ...
    func testManualTokenDeepLinkShowsPrompt() throws {
        let app = launchWithManualTokenDeepLink(gatewayURL: "http://127.0.0.1:8080")
    ...
    /// Requires a live:8080 gateway with credentials in the test environment.
