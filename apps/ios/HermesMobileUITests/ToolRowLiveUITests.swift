...
/// live regression guard: a real agent turn that invokes a tool must
...
/// dashboard instance, never a stock gateway — environment
/// rules.
final class ToolRowLiveUITests: XCTestCase {
    ...
    func testLiveToolRowRendersAndCompletes() throws {
        ...
        //  frame. Before the decoder fix this NEVER rendered (the
